...
namespace ifinds.Api.Providers
{
    /// <summary>
    ///
    /// </summary>
    ...
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            if (user == null)
            {
                ApplicationUser foundedUser = await userManager.FindByEmailAsync(context.UserName);
                if (foundedUser != null)
                {
                    user = await userManager.FindAsync(foundedUser.UserName, context.Password);
                }
            }
