...
namespace DTP.Data
{
    public static class SqlHelper
    {
        ...
        /// <param name="columnName">Column name</param>
        /// <returns>A date time</returns>
        public static DateTime? GetNDateTime(IDataReader rdr, string columnName)
        {
            try
            {
                int index = rdr.GetOrdinal(columnName);
        ...
        /// <returns></returns>
        public static int ExecuteNonQuery(string Connection, string spName, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        public static DataSet ExecuteDataset(string strConnection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            // Create & open a SqlConnection, and dispose of it after we are done
        ...
        /// <returns></returns>
        public static DataSet ExecuteDataset(string strConnection, CommandType commandType, string commandText, int TimeOut, params SqlParameter[] commandParameters)
        {
            // Create & open a SqlConnection, and dispose of it after we are done
            using (SqlConnection connection = new SqlConnection(strConnection))
            {
        ...
        public static DataSet ExecuteDataset(string strConnection, string spName, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                // Call the overload that takes an array of SqlParameters
                return ExecuteDataset(strConnection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                // Otherwise we can just call the SP without params
                return ExecuteDataset(strConnection, CommandType.StoredProcedure, spName);
            }
        }
        /// <summary>
        /// DNH 
        ...
        /// <param name="strConnection"></param>
        /// <param name="spName"></param>
        /// <param name="TimeOut">add time out for the system</param>
        /// <param name="parameterValues"></param>
        /// <returns></returns>
        public static DataSet ExecuteDataset(string strConnection, string spName, int TimeOut = 30, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                // Call the overload that takes an array of SqlParameters
                return ExecuteDataset(strConnection, CommandType.StoredProcedure, spName, TimeOut, commandParameters);
            }
            else
            {
                // Otherwise we can just call the SP without params
                return ExecuteDataset(strConnection, CommandType.StoredProcedure, spName, TimeOut);
            }
        }
        ...
        /// <summary>
        /// DNH Execute a SqlCommand (that returns a resultset) against the specified SqlConnection
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:
        ...
        private static SqlDataReader ExecuteLongReader(SqlConnection connection, SqlTransaction transaction, CommandType commandType,
            string commandText, SqlParameter[] commandParameters, SqlConnectionOwnership connectionOwnership, int TimeOut)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        public static SqlDataReader ExecuteReader(string Connection, string spName, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        public static SqlDataReader ExecuteReaderService(string strConnection, string spName, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                return ExecuteMyReader(strConnection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                // Otherwise we can just call the SP without params
                return ExecuteMyReader(strConnection, CommandType.StoredProcedure, spName);
            }
        }
        public static SqlDataReader ExecuteLongReaderService(string strConnection, int? TimeOut, string spName, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            int DefaultTime = TimeOut.HasValue ? TimeOut.Value : 30;
            // If we receive parameter values, we need to figure out where they go
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                SqlParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(strConnection, spName);
                ...
                return ExecuteMyReader(strConnection, DefaultTime, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                // Otherwise we can just call the SP without params
                return ExecuteMyReader(strConnection, DefaultTime, CommandType.StoredProcedure, spName);
            }
        }
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        public static SqlDataReader ExecuteMyReader(string strConection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            SqlConnection connection = null;
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        public static SqlDataReader ExecuteMyReader(string strConection, int? TimeOut, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            SqlConnection connection = null;
            int DefaultTime = TimeOut.HasValue ? TimeOut.Value : 30;
            try
            {
                ...
                //// Call the private overload that takes an internally owned connection in place of the connection string
                return ExecuteLongReader(connection, null, commandType, commandText, commandParameters, SqlConnectionOwnership.Internal, DefaultTime);
            }
            catch
            {
                // If we fail to return the SqlDatReader, we need to close the connection ourselves
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        public static SqlDataReader ExecuteReaderService(string strConnection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            SqlConnection connection = null;
            try
            {
