...
namespace DTP.Core
{
    ...
    {
        /// <summary>
        /// return sqlReader to Object List
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="reader"></param>
        /// <returns></returns>
        public static IEnumerable<T> DataReaderToList<T>(IDataReader sqlReader) where T : class, new()
        {
            return DataHelper.DataReaderMapToList<T>(sqlReader);
        }

        public static T DataReaderToObject<T>(IDataReader sqlReader)
        {
            return DataHelper.DataReaderMapTo<T>(sqlReader);
        }
