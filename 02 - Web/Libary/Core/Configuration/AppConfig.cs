...
namespace Biz.Core.Configuration
{
    ...
    public partial class AppConfig : IConfigurationSectionHandler
    {
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var UserFolder = section.SelectSingleNode("UserFolder");
            config.UserDataFolder = GetString(UserFolder, "Folder");

            var UserSiteMapFolder = section.SelectSingleNode("UserSiteMapFolder");
            config.UserSiteMapFolder = GetString(UserSiteMapFolder, "Folder");

            var UserFileImportFolder = section.SelectSingleNode("UserFileImportFolder");

            config.UserFileImportFolder = GetString(UserFileImportFolder, "Folder");
            return config;
        }
        ...
        public string UserSiteMapFolder { get; set; }

        public string UserFileImportFolder { get; set; }
    }
}
