...
{
    [CustomAuthorize]
	[AccessRights("T_COM_Master_Employee_Position")]
    [RoutePrefix("EmpPosition")]
    public class T_COM_Master_Employee_PositionController :  BaseController
    {
		string ViewFolder = "~/Views/OG/T_COM_Master_Employee_Position/";
        ...
        public SearchFilter BindSearch(string searchprm)
        {
            ...
            SearchKey.ColumnsName = "ID,EmployeeCode";
            SearchKey.Page = 1;
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult Create(string TargetID = "T_COM_Master_Employee_Positionlist")
        {
            return View(ViewFolder + "Create.cshtml",new T_COM_Master_Employee_Position()
            {
				ID = 0,
        ...
        public ContentResult ImportExcelFile()
        {
            ...
            //DataTable dt = ExcelHelper.getClassFromExcelPackage<T_COM_Master_Employee_Position>(file.InputStream, 2,1);
            obj.StatusCode = 200;
