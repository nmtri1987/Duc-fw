...
namespace Biz.CS.Services
{
  ...
  //      private const string SETTINGS_ID_KEY = "ifinds.Models.DNHSiteMap.{0}{1}";
		//private const string SETTINGS_User_KEY = "ifinds.Models.DNHSiteMap.USer.{0}{1}";
		//private const string SETTINGS_Search_KEY = "ifinds.Models.DNHSiteMap.Search.{0}{1}{2}{3}{4}{5}";
  //      private const string Resource = "DNHSiteMap";
  //      #endregion
        #region Constants
        private const string SETTINGS_ALL_KEY = "DNHSiteMap.all{0}";
        private const string SETTINGS_ID_KEY = "DNHSiteMap.{0}{1}";
        private const string SETTINGS_User_KEY = "DNHSiteMap.USer.{0}{1}";
        private const string SETTINGS_Search_KEY = "DNHSiteMap.Search.{0}{1}{2}{3}{4}{5}";
        private const string Resource = "DNHSiteMap";
        #endregion
   ...
   //         }
            ...
            HttpCache.RemoveByPattern(string.Format("ifinds.Models.DNHSiteMap.all{0}", objItem.CompanyID));
            HttpCache.RemoveByPattern(string.Format(SETTINGS_ALL_KEY, objItem.CompanyID));
            HttpCache.RemoveByPattern(string.Format(SETTINGS_ID_KEY, objItem.NodeID, objItem.CompanyID));
            HttpCache.RemoveByPattern(string.Format(SETTINGS_User_KEY, objItem.CreatedUser, objItem.CompanyID));
            HttpCache.RemoveSearchCache(SystemConfig.AllowSearchCache, SETTINGS_Search_KEY);
        ...
        /// <summary>
        /// return the sitemap collection by UserName --> UserInRoles--> RolesInSiteMap -->SiteMap
        /// </summary>
