...
(function (s, r, m) {
    ...
    if (u0q.M.Y(0, 1740494) === o7n || u0q.M.Y(0, 7092314) === h7n || u0q.M.Y(0, 2861055) === X7n || u0q.M.Y(0, 3236777) === P7n || u0q.M.Y(0, 6708786) === L7n) {
        var w = function (d, u) {
            ...
            e[("mo" + "d" + "els")] = {}
            ;
            e[("mo" + "d" + "el" + "s")][("di" + "s" + "p" + "lay" + "Co" + "n" + "trol" + "l" + "er")] = {
                init: function () {
                }, open: function () {
                }, close: function () {
                }
            ...
            e.prototype.buttons = function (a) {
                ...
                d[("each")](a, function (a, k) {
                    ("s" + "t" + "rin" + "g") === typeof k && (k = {
                        label: k, fn: function () {
                            this[("s" + "ub" + "mit")]();
                        }
                    }
                        );
                    d("<button></button>", { "class": b[("cla" + "sses")][("fo" + "rm")][("butt" + "on")] + (k["className"] || "") }
            ...
            e.prototype._submit = function (a, b, c, e) {
                var g = this, f = u["ext"][("o" + "Api")][("_f" + "nS" + "e" + "t" + "Obj" + "ec" + "t" + "D" + "at" + "a" + "Fn")], h = {}
                    , i = this["s"][("fields")], j = this["s"][("act" + "i" + "o" + "n")], l = this["s"]["editCount"], o = this["s"][("m" + "od" + "if" + "i" + "e" + "r")], n = {
                        action: this["s"][("a" + "ctio" + "n")], data: {}
                    }
                ;
            ...
            ;
            e[("d" + "ef" + "au" + "l" + "ts")] = {
                table: null, ajaxUrl: null, fields: [], display: ("l" + "i" + "g" + "h" + "t" + "b" + "ox"), ajax: null, idSrc: null, events: {}, i18n: {
                    create: { button: ("New"), title: ("C" + "re" + "a" + "t" + "e" + " " + "n" + "e" + "w" + " " + "e" + "n" + "try"), submit: ("C" + "r" + "e" + "a" + "t" + "e") }, edit: { button: ("E" + "dit"), title: ("E" + "d" + "i" + "t" + " " + "e" + "nt" + "r" + "y"), submit: ("Up" + "da" + "t" + "e") }, remove: {
                        button: ("D" + "elete"), title: "Delete", submit: ("De" + "le" + "te"), confirm: { _: ("A" + "r" + "e" + " " + "y" + "o" + "u" + " " + "s" + "ure" + " " + "y" + "ou" + " " + "w" + "i" + "s" + "h" + " " + "t" + "o" + " " + "d" + "e" + "l" + "ete" + " %" + "d" + " " + "r" + "o" + "ws" + "?"), 1: ("A" + "r" + "e" + " " + "y" + "o" + "u" + " " + "s" + "ur" + "e" + " " + "y" + "o" + "u" + " " + "w" + "is" + "h" + " " + "t" + "o" + " " + "d" + "elet" + "e" + " " + "1" + " " + "r" + "o" + "w" + "?") }
            ...
            ), j[("editor" + "_edi" + "t")] = d[("e" + "xten" + "d")](!0, j[("s" + "e" + "l" + "ect" + "_si" + "ng" + "le")], {
                sButtonText: null, editor: null, formTitle: null, formButtons: [
                        {
                            label: null, fn: function () {
                                this["submit"]();
            ...
            ), j["editor_remove"] = d["extend"](!0, j[("se" + "le" + "ct")], {
                sButtonText: null, editor: null, formTitle: null, formButtons: [
                        {
                            label: null, fn: function () {
                                var a = this;
